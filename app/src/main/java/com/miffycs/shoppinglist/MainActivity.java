...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Creates a new ArrayList every time the app starts
        // disabled so that we can store the list on phone's local storage and have it keep the data instead
//        shoppingList = new ArrayList<>();
        shoppingList = getArrayVal(getApplicationContext());
        // Add test Items upon starting the app, disabled
...
//        shoppingList.add("Toothpaste");
        // Sort items every time you open the app
        ...
        if (id == R.id.action_add) {
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    // sorts the entire collection and refreshes the screen everytime you add an item
                    Collections.sort(shoppingList);
    ...
    public void removeElement(String selectedItem, final int position){
        ...
        builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                // sorts the entire collection and refreshes the screen everytime after an item is removed
                Collections.sort(shoppingList);
                storeArrayVal(shoppingList, getApplicationContext());
                lv.setAdapter(adapter);
            }
